...
import AddEditAboutDialog from "@/components/About/AddEditAboutDialog";
...
export default function NavBar() {
  const [showAddAboutDialog, setShowAddAboutDialog] = useState(false);
  ...
  return (
    <>
            ...
            <TooltipProvider>
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button onClick={() => setShowAddAboutDialog(true)}>
                    Add About RR
                    <Plus size={20} className="ml-2" />
                  </Button>
                </TooltipTrigger>
                <TooltipContent>
                  <p>Add details or information about Rachmat Rizki.</p>
                </TooltipContent>
              </Tooltip>
            </TooltipProvider>
          </div>
      ...
      <AddEditAboutDialog
        open={showAddAboutDialog}
        setOpen={setShowAddAboutDialog}
      />
    </>
  );
}
